...
export default function CursorPreview() {
  return (
    <div className="relative min-h-64 overflow-hidden rounded-lg border border-white/10 bg-slate-900 p-6">
      ...
      <p className="text-sm font-black uppercase tracking-[0.2em] text-cyan-200">Pointer effects</p>
      <h3 className="mt-4 max-w-sm text-4xl font-black text-white">Cursor interaction preview</h3>
